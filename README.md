...
> [!NOTE]
> This is the maintained ReRevved project fork.
> Its maintained branch is `rerevved-sdk`; `main` remains an unmodified mirror of upstream ReXGlue.
> See [Maintaining the fork](docs/MAINTAINING.md) for the integration and artifact policy.
